...
main(int argc, char **argv)
{
	...
	//The first two blocks are allocated for the entries for the root and lost+found directories.
        ...
        //The root directory and lost+found directory inodes must be initialized.
